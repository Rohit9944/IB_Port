  ...
  <div class="content-wrapper">
    <div class="row dashboard-card-top d-flex align-items-center mb-4">
      ...
      <div class="col-lg-6 text-right d-flex align-items-center justify-content-end headerBtn">
        <a href="{{ route('admin.users.cargo-owners.add') }}" class="btn btn-primary px-2"><i class="mdi mdi-plus"></i> Add Cargo Owner</a>
      </div>
    </div>
    ...
    <div class="row flex-grow">
      <div class="table-responsive  mt-1">
           ...
           <table class="table table-bordered align-middle">
                    ...
                    <a href="{{ route('admin.users.cargo-owners.edit') }}" class="btn btn-outline-warning btn-fw"><i class="mdi mdi-lead-pencil"></i></a>
