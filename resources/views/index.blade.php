        ...
        <div class="container">
            ...
            <div class="row justify-content-md-center gy-4 my-2">
                <div class="col-xl-4 col-md-6">
                    <article class="blog-entry2 bg-info round m-auto m-xl-0">
                        <div class="blog-thumb">
                            <a href="about-us.html"><img src="{{asset('/assets/images/blog4.png')}}" alt="" class="img-fluid"></a>
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <article class="blog-entry2 bg-info round m-auto m-xl-0">
                        <div class="blog-thumb">
                            <a href="about-us.html"><img src="{{asset('/assets/images/blog5.jpg')}}" alt="" class="img-fluid"></a>
                        </div>
                        <div class="blog-inner">
                            <div class="blog-meta d-flex gap-4">
                                <span><a href="#"><i class="fa-regular fa-user"></i>Adam
                ...
                <div class="col-xl-4 col-md-6">
                    <article class="blog-entry2 bg-info round m-auto m-xl-0">
                        <div class="blog-thumb">
                            <a href="about-us.html"><img src="{{asset('/assets/images/blog6.jpg')}}" alt="" class="img-fluid"></a>
                        </div>
                        <div class="blog-inner">
                            <div class="blog-meta d-flex gap-4">
                                <span><a href="#"><i class="fa-regular fa-user"></i>Adam
