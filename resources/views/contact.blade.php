                ...
                <div class="col-xl-4">
                    <div class="contact-card d-flex">
                        ...
                        <div class="contact-info">
                            ...
                            <a href="#" class="ct-url">MAKE AN APPOINTMENT <i class="fa-solid fa-angles-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                        ...
                        <div class="form-inner round">
                            <form id="ajax-contact" method="post" action="mailer.php">
                                <div class="row">
                                    ...
                                    <!-- Freight Type -->
                                    <div class="form-group col-lg-6">
                                        <select class="form-control tv-select" id="ftype" name="ftype" required="">
                                            <option value="">Select Freight Type</option>
                                            <option value="Freight Sky">Freight Sky</option>
                                            <option value="Freight Ship">Freight Ship</option>
                                            <option value="Freight Road">Freight Road</option>
                                        </select>
                                    </div>

                                    <!-- Load -->
                                    <div class="form-group col-lg-6">
                                        <select class="form-control tv-select" id="wight" name="wight" required="">
