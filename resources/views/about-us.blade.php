...
<!-- About Section Start -->
    <section class="about-sec2 sec-padding">
        ...
        <div class="container position-relative pt-5 mt-3">
...
<!-- brands slider -->
    ...
    <section class="team-sec2 sec-padding">
        <div class="container">
            <div class="d-flex flex-column flex-xl-row align-items-center justify-content-center gap-5">

                <div class="sec-intro mx-auto text-center text-lg-start mb-4">
                    <span class="sub-title fadeInUp" style="transform: translate(0px, 0px); opacity: 1;">
                    ...
                    <h2 class="sec-title">Our talent and professional members</h2>
                    <p class="lead">Meet friendly, experienced, knowledgeable and dynamic team members who always make
                        our
                        customers pleased with.
                    </p>
                    <p class="lead">
                        Team with a wide range of experience in the shipping industry, we are committed to providing the
                        best service to our customers and Has Over 25
                        years Of Experience
                        Planning,Organizing And Directing The Operations Of A Shipping Company.
                    </p>
                </div>

                <div class="row g-5 g-lg-4">
                    <div class="col-12 col-md-6">
                        <div class="team-card2 position-relative rounded-4 mx-auto mx-md-0"
                            style="background: url('{{asset('assets/images/single-team.jpg')}}') no-repeat;">
                            <div class="team-info text-start">
                                <div class=" d-flex align-items-center justify-content-between mb-3">
                                    <div>
                                        <h4 class="">Mr. Rajneesh Sharma</h4>
                                        <p class="text-primary fw-bold m-0">Chief Executive Officer</p>
                                    </div>
                                    <div class="tm-social d-flex align-items-center gap-3">
                                        <a href="https://www.instagram.com/ibportdash/">
                                            <i class="fab fa-instagram fs-3"></i></a>

                                        <a href="https://www.linkedin.com/company/ibportdash/">
                                            <i class="fab fa-linkedin-in fs-3"></i></a>
                                    </div>
                                </div>
                                <p class="team-desc m-0">
                                    Co Founder And Director At Interbulk Ship Brokers Pvt. Ltd. Mr. Rajneesh Has Over 25
                                    years Of Experience
                                    Planning,Organizing And Directing The Operations Of A Shipping Company.
                                </p>
                            </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="team-card2 position-relative rounded-4 mx-auto mx-md-0"
                            ...
                            <div class="team-info text-start">
                                <div class=" d-flex align-items-center justify-content-between mb-3">
                                    <div>
                                        <h4 class="">Mr. Ashish Dhall</h4>
                                        <p class="text-primary fw-bs-6 m-0">Chief Operating Officer</p>
                                    </div>
                                    <div class="tm-social d-flex align-items-center gap-3">
                                        <a href="https://www.instagram.com/ibportdash/">
                                            <i class="fab fa-instagram fs-3"></i></a>
                                ...
                                <p class="team-desc m-0">
                                    Founder And Managing Director At Interbulk Ship Brokers Pvt. Ltd. Mr. Ashish Has
                                    Over 25
                                    Years Of Experience
                                    Planning,Organizing And Directing The Operations Of A Shipping
                                    Company.
                                </p>
                            </div>
                        </div>
