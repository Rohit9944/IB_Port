...
!(function (e) {
  ...
  e("#tv-nav-monthly").length &&
    (function () {
      const t = {
        ...
        o = (e) => {
          (t.switcher.prop("checked", e),
            t.monthly.toggleClass("is-active", e),
            t.yearly.toggleClass("is-active", !e),
            t.tabMonthly.toggleClass("tv-tab-hide", !e),
            t.tabYearly.toggleClass("tv-tab-hide", e));
        };
      ([t.monthly, t.yearly].forEach((e) =>
        e.on("click", () => o(e.is(t.monthly))),
      ),
        t.switcher.on("click", () => o(!t.monthly.hasClass("is-active"))));
    })();
  var t,
    o = e(".offcanvas-nav-btn"),
    a = e(".navbar:not(.navbar-clone) .offcanvas-nav");
  function s(e) {
    ...
    const a = t.closest("li.nav-item.dropdown.show");
    (a &&
      a.addEventListener("hidden.bs.dropdown", () => {
        document
  ...
  (a.length &&
    ((t = new bootstrap.Offcanvas(a[0], { scroll: !0 })),
    o.on("click", function () {
    ...
    e(".btn")
      .on("mouseenter", function (t) {
        var o = e(this).offset(),
          a = t.pageX - o.left,
          s = t.pageY - o.top;
        e(this).find("span").css({ top: s, left: a });
      })
    ...
    e(window).on("scroll", function () {
      var t = e(".sticky-height"),
        o = e(".header-nav-wrapper");
      if (o.length) {
        var a = o.outerHeight(),
          s = e(".header-top"),
          n = (s.length ? s.outerHeight() : 0) + 200;
        e(window).scrollTop() > n
          ? (o.addClass("scroll-on"), t.length && t.css("height", a + "px"))
          : (o.removeClass("scroll-on"), t.length && t.css("height", "0"));
      }
    }),
    e(".canvas-menu .navbar .dropdown-toggle").append(
      '<i class="fas fa-angle-down"></i>',
    ),
    e(".canvas-menu .submenu").before(
      '<i class="fas fa-angle-down switcher"></i>',
    ),
    e(".vertical-menu li i.switcher").on("click", function () {
      var t = e(this).next(".submenu");
      (t.slideToggle(300), t.parent().toggleClass("openmenu"));
    }),
    e("button.burger-menu").on("click", function () {
      (e(".canvas-menu").toggleClass("open"),
        e(".main-overlay").toggleClass("active"));
    }),
    e(".canvas-menu .canvas-close, .main-overlay").on("click", function () {
  ...
  (document.querySelectorAll(".social-share .plus").forEach((e) => {
    ...
    e(".team-card .link-icon").on("click", function (t) {
      t.preventDefault();
      var o = e(this);
      (o.closest(".team-card").find(".social-share").toggleClass("active"),
        o.toggleClass("icon-active"));
    }),
      ...
      on: {
        slideChangeTransitionStart: function () {
          (gsap.set(".slide-content > *", { opacity: 0, y: 30 }),
            gsap.set(".hero-slider2 .abs-img", { opacity: 0, y: 30 }));
        },
        slideChangeTransitionEnd: function () {
          const e = document.querySelector(".swiper-slide-active");
          e &&
            (gsap.to(e.querySelectorAll(".slide-content > *"), {
              opacity: 1,
              y: 0,
              duration: 0.8,
              stagger: 0.15,
  ...
  e(".marque-active").length &&
    e(".marque-active").marquee({
      gap: 48,
      speed: 80,
      delayBeforeStart: 0,
      direction: "left",
  ...
  (new Swiper(".services-carousel", {
    ...
    speed: 600,
    autoplay: !0,
    pagination: { el: ".ct-pagination .swiper-pagination", clickable: !0 },
    navigation: {
      nextEl: ".swiper-button-next",
      prevEl: ".swiper-button-prev",
    },
  ...
  var n = new Swiper(".product-thumb", {
    spaceBetween: 10,
    slidesPerView: 4,
    freeMode: !0,
    ...
    breakpoints: {
      320: { direction: "horizontal", slidesPerView: 3 },
      576: { direction: "vertical", slidesPerView: 4 },
    },
  });
  new Swiper(".coverItem", { spaceBetween: 10, thumbs: { swiper: n } });
  (e(".quantity").on("click", ".plus, .minus", function () {
    const t = e(this),
      o = t.closest(".quantity").find(".qty");
    ...
    ((a && !isNaN(a)) || (a = 1),
      ...
      (n && !isNaN(n)) || (n = 1),
      (i =
        "any" === i || "" === i || void 0 === i || isNaN(parseFloat(i))
          ? 1
          : parseFloat(i)));
      ...
      !(function () {
        ...
        if (t.length && o.length) {
          ...
          (o.css({
            ...
            o.css("transition", "stroke-dashoffset 10ms linear"));
          const n = function () {
            const t = e(window).scrollTop(),
              a = e(document).height() - e(window).height(),
              n = s - (t * s) / a;
            o.css("stroke-dashoffset", n);
          };
          ...
          (e(window).on("scroll", function () {
            ...
            t.on("click", function (t) {
              (t.preventDefault(),
                e("html, body").animate({ scrollTop: 0 }, 600, "swing"));
            }));
        }
      })();
    }),
    e(window).on("load", function () {
      ...
      (t.isotope({
        ...
        e(".portfolio-menu .nav-link").on("click", function (o) {
          o.preventDefault();
          var a = e(this).attr("data-filter");
          (t.isotope({ filter: a }),
            e(".portfolio-menu .nav-link").removeClass("active"),
            e(this).addClass("active"));
        }));
    }));
  let i = document.querySelectorAll(".sec-title");
  if (i.length) {
    let e = 0.03,
      t = 20,
      o = 0.1,
      a = "power2.out";
    i.forEach((s) => {
      let n = new SplitText(s, { type: "chars, words" });
      gsap.from(n.chars, {
        duration: 1,
        delay: o,
        x: t,
  ...
  (e(".fadeInUp").length > 0 &&
    gsap.utils.toArray(".fadeInUp").forEach((e) => {
      let t = e.getAttribute("data-fade-offset") || 40,
        o = e.getAttribute("data-duration") || 0.75,
        a = e.getAttribute("data-fade-from") || "bottom",
        s = e.getAttribute("data-on-scroll") || 1,
        n = e.getAttribute("data-delay") || 0.15,
        i = {
          opacity: 0,
          ease: e.getAttribute("data-ease") || "power2.out",
          duration: o,
          delay: n,
          x: "left" == a ? -t : "right" == a ? t : 0,
          y: "top" == a ? -t : "bottom" == a ? t : 0,
        };
      (1 == s && (i.scrollTrigger = { trigger: e, start: "top 85%" }),
        gsap.from(e, i));
    }),
    e("#ship_time").timepicker({ timeFormat: "h:mm p", interval: 60 }),
    e("#ship_date").datepicker({ format: "mm-dd-yyyy" }));
  e(".progress-circle-item").each(function () {
    const t = e(this),
      o = t.find(".number"),
      a = t.find(".progress-stroke"),
      s = parseFloat(o.attr("data-target"));
    e({ Counter: 0 }).animate(
      { Counter: s },
      {
        duration: 1500,
