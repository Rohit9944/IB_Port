...
<div class="actionBtn d-flex align-items-center justify-content-center gap-1">
                    ...
                    <a href="<?php echo e(route('ship.cargo-requests.view')); ?>" class="btn btn-outline-warning btn-fw"><i class="mdi mdi-lead-pencil"></i></a>
...
<?php echo $__env->make('ship-owner.include.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  ...
  <?php /**PATH C:\xampp\htdocs\IB_Port\resources\views/ship-owner/cargo-requests/index.blade.php ENDPATH**/ ?>